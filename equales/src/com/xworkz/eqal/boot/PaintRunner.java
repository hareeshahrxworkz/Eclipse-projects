...
public class PaintRunner {
	...
	public static void main(String[] args) {
		...
		Paint paint = new Paint("Aision", "double", 500, "manoj", "banglore", "karnataka", "india", 577542,
				99007780555L, "bittlenut");

		Paint paint1 = new Paint("Aision", "ligth", 700, "mamatha", "rajajinagar", "belagam", "india", 574578,
				99007795212L, "Nut");
		...
		Vechile vechile1 = new Vechile("Marutu susuki", "Swift", "white", "susuki", "petrol", "Apr-2011", 8000,
		...
		Lipstik lipstik = new Lipstik("Bullete", "lipstik", 800, "red", "female", "soft", "Girls", 20, "Belagavi",
				"Karnatak", "india");
		Lipstik lipstik2 = new Lipstik("Bullete", "lipstik", 800, "red", "female", "soft", "Girls", 60, "Belagavi",
				"Karnatak", "india");
		...
		WateBottle wateBottle2 = new WateBottle("Kingfisher", "aqua", 80, 950, "30mm", "4.5circle", "may/2023",
				"jul/2023", "Prakash", "india");
		...
		Currency currency1 = new Currency("rupe", "india", true, "Mysore", "coin", "brown", "Gandiji", "2022", 500);
